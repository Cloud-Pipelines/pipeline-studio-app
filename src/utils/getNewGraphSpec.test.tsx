...
import getNewGraphSpec from "./getNewGraphSpec";
import type { ArgumentType, GraphSpec } from "../componentSpec";

describe("getNewGraphSpec", () => {
  it("should update task arguments for an existing task", () => {
    ...
    const result = getNewGraphSpec(taskId, initialGraphSpec, taskArguments);
  ...
  it("should handle undefined taskArguments by keeping existing arguments", () => {
    ...
    const result = getNewGraphSpec(taskId, initialGraphSpec);

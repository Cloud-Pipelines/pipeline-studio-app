...
const getTaskNodes = (graphSpec: GraphSpec, componentSpec: ComponentSpec, setComponentSpec: SetComponentSpec) => {
  return Object.entries(graphSpec.tasks).map<Node<any>>(([taskId, taskSpec]) => {
    ...
    return {
      ...
      data: {
        ...
        setArguments: (args: Record<string, ArgumentType>) => {
          setTaskArguments(taskId, graphSpec, componentSpec, setComponentSpec, args)
        },
      },
      position: position,
      type: "task",
...
const extractPositionFromAnnotations = (annotations?: Record<string, unknown>): XYPosition => {

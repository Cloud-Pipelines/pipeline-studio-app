...
const FlowCanvas = ({
  ...
  const onDuplicateNodes = useCallback(() => {
    const { updatedComponentSpec: updatedSubgraphSpec, newNodes, updatedNodes } = duplicateNodes(
      currentSubgraphSpec,
      selectedNodes,
      { selected: true },
    );
  ...
  }, [currentGraphSpec, selectedNodes, updateGraphSpec, notify, triggerConfirmation]);

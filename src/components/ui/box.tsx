...
/**
 * Configurable container primitive, modeled on Shopify Polaris Box. Token-only
 * escape hatch; use BlockStack / InlineStack for layout.
 */
...
interface BoxOwnProps extends AriaAttributes {
  ...
  /** Marks this Box a Tailwind `group` parent so descendants can use `group-hover:*`. */
  group?: boolean;
}

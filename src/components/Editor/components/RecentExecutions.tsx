...
const RecentExecutions = ({ pipelineName }: { pipelineName?: string }) => {
  ...
  if (isLoading) {
    return (
      <div>
        {titleMarkup}
        <div className="h-48 bg-gray-50 border border-gray-300 rounded p-2 flex items-center justify-center">
  ...
  return (
    <div>
      ...
      {recentRuns.length === 0 ? (
        ...
        <ScrollArea className="h-fit bg-gray-50 border border-gray-300 rounded p-2">
          {runOverviews}
          {remainingRuns > 0 && (

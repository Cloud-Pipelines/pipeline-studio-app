    ...
    <div className="p-2 flex flex-col gap-6">
      ...
      {fileMeta.digest && (
        <div className="mb-2">
          ...
          <Button
            className="bg-gray-100 border border-gray-300 rounded p-2 text-xs w-full text-left hover:bg-gray-200 active:bg-gray-300 transition cursor-pointer"
            onClick={() => {
              if (fileMeta.digest) {
            ...
            variant="ghost"
          >
            <span className="font-mono break-all">{fileMeta.digest}</span>
          </Button>
        </div>
      )}
